            ...
            <div class="row">
                ...
                <?php endif; ?>
                    ...
                    <?php if( ! kt_is_mobile() ): ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <div class="product-featured-tab-content <?php if( ! kt_is_mobile() ): ?> box-right <?php endif; ?> <?php if(count( $has_banner_left ) > 0 ): ?>has_attachment<?php endif; ?>">
