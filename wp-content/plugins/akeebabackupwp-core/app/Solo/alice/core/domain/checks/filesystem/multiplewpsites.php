...
class AliceCoreDomainChecksFilesystemMultiplewpsites extends AliceCoreDomainChecksAbstract
{
	...
	{
		parent::__construct(20, Text::_('ALICE_ANALYZE_FILESYSTEM_MULTIPLE_WPSITES'), $logFile);
	}
	...
	public function check()
	{
		...
		if ($subfolders)
		{
			...
			throw new Exception(Text::sprintf('ALICE_ANALYZE_FILESYSTEM_MULTIPLE_WPSITES_ERROR', '<br/>' . implode('<br/>', $subfolders)));
		}
	...
	{
		return Text::_('ALICE_ANALYZE_FILESYSTEM_MULTIPLE_WPSITES_SOLUTION');
	}
}
